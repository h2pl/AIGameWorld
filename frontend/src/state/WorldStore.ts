...
class WorldStore {
  private state: WorldState = {
    world_id: "", runtime: { llm_mock: false, data_mode: "real", db_name: "" },
    display_tick: 0, current_scene_id: "", current_scene_name: "",
  };
  ...
  setDisplayTick(tick: number): void { this.state.display_tick = tick; }
