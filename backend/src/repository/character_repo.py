    ...
    async def save_pc(self, pc: PlayerCharacter) -> None:
        ...
        """,
            (
                ...
                pc.combat_engine.model_dump_json(),
    ...
    async def save_actor(self, actor: Actor) -> None:
        ...
        """,
            (
                ...
                actor.combat_engine.model_dump_json() if actor.combat else None,
                actor.personality,
                json.dumps(list(actor.functions)),
...
def _actor_from_row(row: dict) -> Actor:
    ...
    return Actor(
        ...
        personality=_val(row, "personality", ""),
        functions=list(json.loads(row["functions_json"])),
