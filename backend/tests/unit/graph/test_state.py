...
from src.graph.state import OverallState, CharacterSubState, EngineSubState, ReflectionSubState


class TestOverallState:
    def test_minimal_state(self):
        s: OverallState = {
            "tick": 0, "dm_instructions": [], "plot_brief": "",
            "scene_direction": {}, "world_events": [], "character_actions": [],
            "engine_results": [], "combat_result": None, "state_diff": {},
            "cast_changes": [], "narrative": "", "reflected_characters": [],
    ...
    def test_world_events_annotated_add(self):
        ...
        s: OverallState = {
            "tick": 0, "dm_instructions": [], "plot_brief": "",
            "scene_direction": {}, "world_events": [{"e": 1}],
            "character_actions": [], "engine_results": [], "combat_result": None,
            "state_diff": {}, "cast_changes": [], "narrative": "",
    ...
    def test_errors_annotated_add(self):
        s: OverallState = {
            ...
            "engine_results": [], "combat_result": None, "state_diff": {},
            "cast_changes": [], "narrative": "", "reflected_characters": [],
            "summary_compressed": False, "errors": ["error1", "error2"],
...
class TestEngineSubState:
    def test_engine_substate(self):
        s: EngineSubState = {
            "participants": ["a", "b"], "round": 1, "speaker": "",
            "target": "", "intent": "", "character_id": "", "action_type": "",
            "quests": [], "event_log": [], "engine_results": [],
            "combat_result": None,
        }
...
class TestReflectionSubState:
    def test_reflection_substate(self):
        s: ReflectionSubState = {
            "tick": 5, "character_id": "pc1", "memories": [{"text": "m1"}],
